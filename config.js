...
const CONFIG = {
  ...
  accounts: {
    groom: [
      { role: "남지훈", name: "남지훈", bank: "국민은행", number: "205502-04-598759" }
        ],
    bride: [
      { role: "안경진", name: "안경진", bank: "국민은행", number: "697201-00-080302" },
      { role: "안승출", name: "안승출", bank: "농협은행", number: "352-1756-2004-13" }
    ]
  },
